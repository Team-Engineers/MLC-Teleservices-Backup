    ...
    <>
      {TOKEN ? (
          ...
          <>
            <div className="bg-base-100  p-6 rounded-lg shadow-lg">
              <p className="text-lg font-semibold mb-4">
                🌟 Welcome to <strong>MLC Teleservices!</strong> 🌟
              </p>
              ...
              <p className="text-sm mt-4">Best regards, MLC Teleservices</p>
            </div>
          </>
        ) : (
          <div className="bg-base-100  p-6 rounded-lg shadow-lg">
        ...
        <>
          ...
          <p className="text-lg mt-6">
            Ready to boost your career? Join MLC Teleservices!
            <a
